...
public class Lienzo extends Canvas {
    ...
    public boolean mouseMove(Event evt, int x, int y) {
        if (modificaranchod) {
            ...
            this.getElem().elementAt(4).set(3, (800 - x) / 2);
            this.getElem().elementAt(4).set(1, x);
            this.getElem().elementAt(6).set(3, (800 - x) / 2);
            this.getElem().elementAt(6).set(1, x);
    ...
    public void paint(Graphics g) {
        ...
        for (int i0 = 0; i0 < getElem().size(); i0++) {
            if ((Integer) getElem().elementAt(i0).get(0) == 0) {
                ...
                if (i0 == 1) {
                    getGB().drawImage(basepapel1, (Integer) getElem().elementAt(i0).get(1),
                            (Integer) getElem().elementAt(i0).get(2),
                            (Integer) getElem().elementAt(i0).get(3),
                            (Integer) getElem().elementAt(i0).get(4), this);
                }
                if (i0 == 2) {
                    getGB().drawImage(basepapel2, (Integer) getElem().elementAt(i0).get(1),
                            (Integer) getElem().elementAt(i0).get(2),
                            (Integer) getElem().elementAt(i0).get(3),
                            (Integer) getElem().elementAt(i0).get(4), this);
                }
                if (i0 == 3) {
                    getGB().drawImage(basepapel3, (Integer) getElem().elementAt(i0).get(1),
                            (Integer) getElem().elementAt(i0).get(2),
                            (Integer) getElem().elementAt(i0).get(3),
                            (Integer) getElem().elementAt(i0).get(4), this);
                }
